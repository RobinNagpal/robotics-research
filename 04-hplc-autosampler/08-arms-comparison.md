...
> (`05-reBot-implementation/`), the **Elephant myCobot 280**
> (`06-mycobot-280-impl/`), and the **AgileX PiPER**
> (`07-agile-x-piper-impl/`). Which is best **for developing the
...
- Per-arm simulation notes: [`05-reBot-implementation/`](05-reBot-implementation/README.md),
  [`06-mycobot-280-impl/`](06-mycobot-280-impl/README.md),
  [`07-agile-x-piper-impl/`](07-agile-x-piper-impl/README.md)
