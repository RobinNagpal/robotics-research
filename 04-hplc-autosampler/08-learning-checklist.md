...
> like our [HPLC autosampler](02-high-level-solution/README.md) or
...
> **[`05-mycobot-280-impl/01-only-code/`](05-mycobot-280-impl/01-only-code/README.md)**
...
- [ ] **Read the problem we'll demo** —
  [`02-high-level-solution/README.md`](02-high-level-solution/README.md)
...
- [ ] **Know the sensor story** — read
  [`05-mycobot-280-impl/sensor-suite.md`](05-mycobot-280-impl/sensor-suite.md)
...
- [ ] **Understand:** what a physics simulator and a digital twin are;
  ...
  [`01-only-code/01-simulation-and-digital-twin.md`](05-mycobot-280-impl/01-only-code/01-simulation-and-digital-twin.md).
...
- [ ] **Hello world — "spawn the cell":** load the **myCobot 280 URDF**
  ...
  **Code:** [`03-hello-worlds/01-spawn-the-cell.md`](03-hello-worlds/01-spawn-the-cell.md).

### Layer 2 — Middleware & control (ROS 2)

- [ ] **Understand:** ROS 2 nodes, topics, services, actions; what
  `ros2_control` does. Read
  [`01-only-code/02-middleware-and-control.md`](05-mycobot-280-impl/01-only-code/02-middleware-and-control.md).
...
- [ ] **Hello world — "the mock decapper":** write a tiny **rclpy**
  ...
  **Code:** [`03-hello-worlds/02-mock-decapper.md`](03-hello-worlds/02-mock-decapper.md).

### Layer 3 — Arm motion planning (MoveIt 2)

- [ ] **Understand:** motion planning, inverse kinematics, collision
  checking, planning scene. Read
  [`01-only-code/03-arm-motion-planning.md`](05-mycobot-280-impl/01-only-code/03-arm-motion-planning.md).
...
- [ ] **Hello world — "reach the vial":** with the `mycobot_ros` MoveIt
  ...
  **Code:** [`03-hello-worlds/03-reach-the-vial.md`](03-hello-worlds/03-reach-the-vial.md).
- [ ] **Hello world (extension) — "keep the world current":** stream the
  ...
  **Code:** [`03-hello-worlds/12-keep-the-world-current.md`](03-hello-worlds/12-keep-the-world-current.md).
- [ ] **Hello world (extension) — "close the loop on motion":** write the
  ...
  **Code:** [`03-hello-worlds/13-watch-the-move.md`](03-hello-worlds/13-watch-the-move.md).
...
- [ ] **Hello world — "see the tray":** add a **simulated camera** to the
  ...
  **Code:** [`03-hello-worlds/04-see-the-tray.md`](03-hello-worlds/04-see-the-tray.md).
...
- [ ] **Understand:** grasp pose, antipodal grasp, parallel-jaw gripper;
  ...
  [`01-only-code/05-grasping-and-manipulation.md`](05-mycobot-280-impl/01-only-code/05-grasping-and-manipulation.md).
...
- [ ] **Know the learned frontier (VLAs):** read the upgrade-path section
  of [`05-grasping-and-manipulation.md`](05-mycobot-280-impl/01-only-code/05-grasping-and-manipulation.md)
  and [`foundation-models.md`](05-mycobot-280-impl/foundation-models.md)
...
- [ ] **Hello world — "grab the vial":** compute an **antipodal pinch**
  ...
  **Code:** [`03-hello-worlds/05-grab-the-vial.md`](03-hello-worlds/05-grab-the-vial.md).
- [ ] **VLA hello world #1 (open low-level policy) — "run SmolVLA in
  ...
  **Code:** [`03-hello-worlds/06-run-smolvla-in-sim.md`](03-hello-worlds/06-run-smolvla-in-sim.md).
- [ ] **VLA hello world #2 (frontier planner) — "let Gemini plan the
  ...
  **Code:** [`03-hello-worlds/07-gemini-plans-the-task.md`](03-hello-worlds/07-gemini-plans-the-task.md).
  ...
  > bonus. See [`foundation-models.md`](05-mycobot-280-impl/foundation-models.md).

### Layer 6 — Identification & barcode

- [ ] **Understand:** 1D/2D barcodes, why every vial is tracked, the
  vial→worklist mapping. Read
  [`01-only-code/06-identification-and-barcode.md`](05-mycobot-280-impl/01-only-code/06-identification-and-barcode.md).
...
- [ ] **Hello world — "read the vial ID":** generate a **QR code** for a
  ...
  **Code:** [`03-hello-worlds/08-read-the-vial-id.md`](03-hello-worlds/08-read-the-vial-id.md).
...
- [ ] **Understand:** behavior trees vs state machines; sequence /
  ...
  Read
  [`01-only-code/07-orchestration-and-task-logic.md`](05-mycobot-280-impl/01-only-code/07-orchestration-and-task-logic.md).
...
- [ ] **Hello world — "the per-vial loop":** in **py_trees** (fastest in
  ...
  **Code:** [`03-hello-worlds/09-per-vial-loop.md`](03-hello-worlds/09-per-vial-loop.md).
...
- [ ] **Understand:** worklist, audit trail, why a regulated lab needs
  ...
  [`01-only-code/08-software-worklist-and-compliance.md`](05-mycobot-280-impl/01-only-code/08-software-worklist-and-compliance.md).
...
- [ ] **Hello world — "the mock LIMS + audit log":** a small **FastAPI**
  ...
  **Code:** [`03-hello-worlds/10-mock-lims-and-audit.md`](03-hello-worlds/10-mock-lims-and-audit.md).

### Layer S — Sensors (woven through, do alongside 4/5/7)

- [ ] **Understand:** the [sensor suite](05-mycobot-280-impl/sensor-suite.md)
...
- [ ] **Hello world — "subscribe to a sense":** echo a **simulated
  ...
  **Code:** [`03-hello-worlds/11-subscribe-to-a-sense.md`](03-hello-worlds/11-subscribe-to-a-sense.md).
...
- [ ] **One vial, start to finish, in sim:** `read worklist (L8)` →
  ...
  **Code:** [`03-hello-worlds/14-hello-cell-capstone.md`](03-hello-worlds/14-hello-cell-capstone.md).
...
- [ ] **The wedge / ROI language:** technician-hours saved, fewer
  ...
  [`05-mycobot-280-impl/10-hardware-platform-and-capital-model.md`](05-mycobot-280-impl/10-hardware-platform-and-capital-model.md).
...
- [ ] **Know the arm trade-offs** so you can answer "what hardware?" —
  skim [`07-arms-comparison.md`](07-arms-comparison.md) (myCobot 280 vs
...
- The stack these hello worlds build:
  ...
  [`02-code-plus-hardware/`](05-mycobot-280-impl/02-code-plus-hardware/README.md)).
- The problem being demoed:
  [`02-high-level-solution/`](02-high-level-solution/README.md).
- Sensors, in depth:
  [`05-mycobot-280-impl/sensor-suite.md`](05-mycobot-280-impl/sensor-suite.md).
- VLA / foundation models, in depth:
  [`05-mycobot-280-impl/foundation-models.md`](05-mycobot-280-impl/foundation-models.md).
- Which arm to actually buy: [`07-arms-comparison.md`](07-arms-comparison.md).
- Robotics vocabulary:
  [`../03-place-items-on-shelf/02-glossary.md`](../03-place-items-on-shelf/02-glossary.md).
