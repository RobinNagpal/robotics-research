...
> (`04-reBot-implementation/`), the **Elephant myCobot 280**
> (`05-mycobot-280-impl/`), and the **AgileX PiPER**
> (`06-agile-x-piper-impl/`). Which is best **for developing the
...
- Per-arm simulation notes: [`04-reBot-implementation/`](04-reBot-implementation/README.md),
  [`05-mycobot-280-impl/`](05-mycobot-280-impl/README.md),
  [`06-agile-x-piper-impl/`](06-agile-x-piper-impl/README.md)
