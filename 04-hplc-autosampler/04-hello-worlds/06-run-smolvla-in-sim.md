...
- This is the first of the two **Layer 5** stretch exercises in
  [`../09-learning-checklist.md`](../09-learning-checklist.md). The
...
- A learned policy like this is one possible replacement for the
  ...
  [`../06-mycobot-280-impl/01-only-code/05-grasping-and-manipulation.md`](../06-mycobot-280-impl/01-only-code/05-grasping-and-manipulation.md).
