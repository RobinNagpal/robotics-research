...
[`../03-high-level-solution/10-hardware-platform-and-capital-model.md`](../03-high-level-solution/10-hardware-platform-and-capital-model.md).
...
- For the sibling comparisons, see
  [`../05-reBot-implementation/10-hardware-platform-and-capital-model.md`](../05-reBot-implementation/10-hardware-platform-and-capital-model.md)
  and
