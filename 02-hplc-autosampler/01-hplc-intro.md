...
- **[03 — HPLC workflow](03-hplc-workflow/README.md):** the eight prep
  ...
  real examples.
- **[04 — myCobot 280 implementation](04-mycobot-280-impl/README.md):**
  the per-concern build worked out layer by layer on one low-cost arm.
- **[05 — Arms comparison](05-arms-comparison.md):** which arm to
  simulate first, before buying.
- **[06 — Learning checklist](06-learning-checklist.md):** the skills to
