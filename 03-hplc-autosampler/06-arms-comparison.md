...
> **The question.** We have three candidate arms — the **reBot
> B601-DM**, the **Elephant myCobot 280** (worked out in detail in
> `05-mycobot-280-impl/`), and the **AgileX PiPER**. Which is best
> **for developing the simulated prototype before we spend money on
> hardware?** This note scores them on **30 parameters** through
> exactly that lens.
...
- Per-arm implementation notes: [`05-mycobot-280-impl/`](05-mycobot-280-impl/README.md)
- The problem & solution being simulated: the
