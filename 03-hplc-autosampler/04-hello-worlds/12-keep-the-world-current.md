...
> live."** See [`../07-learning-checklist.md`](../07-learning-checklist.md).
...
- The deeper write-up of motion planning and the planning scene is
  [`../05-mycobot-280-impl/01-only-code/03-arm-motion-planning.md`](../05-mycobot-280-impl/01-only-code/03-arm-motion-planning.md).
- The capstone,
