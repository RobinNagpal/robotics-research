...
> [`../07-learning-checklist.md`](../07-learning-checklist.md) asks you to
...
- The problem all of this is solving: the
  [`../02-lab-bench-new.md`](../02-lab-bench-new.md) sample-prep primer
  and the [`../03-hplc-workflow/`](../03-hplc-workflow/README.md) steps.
