# 07 — Learning checklist: from zero to a credible robotics-agency pitch
...
- [ ] **Lab-automation vocabulary** (so you don't sound naïve to an
  ...
  **SiLA 2**, **OPC UA**, **21 CFR Part 11**, **ALCOA+**, **audit
  ...
  [`05-mycobot-280-impl/09-software-compliance-and-integration.md`](05-mycobot-280-impl/09-software-compliance-and-integration.md).
