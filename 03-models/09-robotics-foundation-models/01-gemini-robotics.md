...
- **The "reason" / "act" split.** Google deliberately separates the
  ...
  in this repo's autosampler orchestration guide
  [`../../02-hplc-autosampler/04-mycobot-280-impl/07-orchestration-and-task-logic.md`](../../02-hplc-autosampler/04-mycobot-280-impl/07-orchestration-and-task-logic.md).
